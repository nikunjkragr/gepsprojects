...
const brochureURL="https://drive.google.com/file/d/11D4KyWgDdKtgGPaX8fQ4bd-de-vFklFU/view?usp=sharing"+"#toolbar=0";
const Home = () => {
    ...
    <div className="home-container">
      ...
      <div className="about-us">
        ...
        <div className="about-buttons">
          ...
          <a href={brochureURL} target="_blank" rel="noopener noreferrer" content>
